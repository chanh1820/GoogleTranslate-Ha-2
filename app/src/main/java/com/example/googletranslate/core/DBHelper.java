package com.example.googletranslate.core;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_PATH = "/data/data/com.example.googletranslate/databases/";
    private static final String DB_NAME = "tuvungtienganh.sqlite";
